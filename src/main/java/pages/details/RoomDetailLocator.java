...
public class RoomDetailLocator {
    ...
    public static final By LOGIN_WARNING_MESSAGE =
            By.cssSelector(".ant-notification-notice-description");
    public static final By BOOKING_SUCCESS_MESSAGE =
            By.xpath("//div[contains(@class,'ant-notification-notice-success')]//div[contains(@class,'ant-notification-notice-message')]");
    public static final By LOGIN_REQUIRED_NOTIFICATION =
            By.xpath("//div[contains(@class,'ant-notification-notice-description') and normalize-space()='Vui lòng đăng nhập để tiếp tục đặt phòng.']");
}
